...
const fhss_config_t domains[] = {
    ...
    {"AFU_440_460_40", FREQ_HZ_TO_REG_VAL(440000000), FREQ_HZ_TO_REG_VAL(460000000), 40},
    {"AFU_460_480_40", FREQ_HZ_TO_REG_VAL(460000000), FREQ_HZ_TO_REG_VAL(480000000), 40},
    {"AFU_480_500_40", FREQ_HZ_TO_REG_VAL(480000000), FREQ_HZ_TO_REG_VAL(500000000), 40},
    {"AFU_500_520_40", FREQ_HZ_TO_REG_VAL(500000000), FREQ_HZ_TO_REG_VAL(520000000), 40},

    {"AFU_720_760_80", FREQ_HZ_TO_REG_VAL(720000000), FREQ_HZ_TO_REG_VAL(760000000), 80},
    {"AFU_760_800_80", FREQ_HZ_TO_REG_VAL(760000000), FREQ_HZ_TO_REG_VAL(800000000), 80},
    {"AFU_800_840_80", FREQ_HZ_TO_REG_VAL(800000000), FREQ_HZ_TO_REG_VAL(840000000), 80},
    {"AFU_840_860_40", FREQ_HZ_TO_REG_VAL(840000000), FREQ_HZ_TO_REG_VAL(860000000), 40},
    {"AFU_940_980_80", FREQ_HZ_TO_REG_VAL(940000000), FREQ_HZ_TO_REG_VAL(980000000), 80},
    {"AFU_980_1020_80", FREQ_HZ_TO_REG_VAL(980000000), FREQ_HZ_TO_REG_VAL(1020000000), 80},

    {"AFU_975_980_10", FREQ_HZ_TO_REG_VAL(975000000), FREQ_HZ_TO_REG_VAL(980000000), 10},
    {"AFU_975_976_10", FREQ_HZ_TO_REG_VAL(975000000), FREQ_HZ_TO_REG_VAL(976000000), 3},
    {"AFU_976_977_10", FREQ_HZ_TO_REG_VAL(976000000), FREQ_HZ_TO_REG_VAL(977000000), 3},
    {"AFU_977_978_10", FREQ_HZ_TO_REG_VAL(977000000), FREQ_HZ_TO_REG_VAL(978000000), 3},
