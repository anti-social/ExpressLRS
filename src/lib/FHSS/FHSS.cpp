...
const fhss_config_t domains[] = {
    ...
    {"AFU_723.5_946.9_40", FREQ_HZ_TO_REG_VAL(723500000), FREQ_HZ_TO_REG_VAL(746900000), 40},
    {"AFU_950.5_973.9_40", FREQ_HZ_TO_REG_VAL(950500000), FREQ_HZ_TO_REG_VAL(973900000), 40},
};
